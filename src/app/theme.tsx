  ...
  dark: {
    ...
    palette: {
      ...
      background: {
        ...
        pageWrapper:
          "linear-gradient(135deg, rgb(10 10 10 / 95%) 20%, rgb(10 10 10 / 70%) )",
      },
      text: {
        primary: "#ffffff",
  ...
  light: {
    ...
    palette: {
      ...
      background: {
        ...
        overlayDark:
          "linear-gradient(0deg,#ffffff,rgba(255, 255, 255, 0.7)25%)",
        pageWrapper:
          "linear-gradient(135deg, rgb(255 255 255 / 95%) 20%, rgb(255 255 255 / 70%) )",
      },
      text: {
        primary: "#727ba2",
        secondary: alpha("#727ba2", 0.7),
        movieContent: "#454a5d",
      },
      primary: {
        main: "#ffffff",
