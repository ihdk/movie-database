...
const SearchBar: React.FC = React.memo(() => {
  ...
  const [currentSearchTerm, setCurrentSearchTerm] = useState<string>(useSelector<RootStoreStateType, string>((state) => state.local.searchTerm));
  ...
  return (
    <Section component="div" spacing="large" className="search-bar" borderRadius={4} darkBg >
