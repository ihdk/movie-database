...
export const Section: React.FC<SectionProps> = React.memo(({
  ...
  return (
    <Box
      ...
      {...props}
    >
      <Container maxWidth={fullwidth ? false : maxWidth} disableGutters={disableGutters} >
        {children}
      </Container>
    </Box>
  )
...
export const FancyLoadingButton = React.memo(styled(LoadingButton)<LoadingButtonProps>(({ theme }) => ({
  whiteSpace: "nowrap",
  color: "#ffffff",
...
export const FancyButton = React.memo(styled(Button)<ButtonProps>(({ theme }) => ({
  whiteSpace: "nowrap",
  color: "#ffffff",
  backgroundImage: theme.palette.background.fancyButton,
  backgroundSize: "200% auto",
...
export const SectionTitle = React.memo(styled(Typography)<TypographyProps>(({ theme }) => ({
  paddingLeft: "1rem",
  position: "relative",
  ":before": {
    content: '""',
...
export const MovieScore: React.FC<MovieScoreProps> = React.memo(({ value, isMovieContent = false, votes = null }) => {
  return (
    <Stack spacing={1}>
      {!isMovieContent && <Typography
        variant="caption"
        component="div"
...
export const ImageWithOverlay: React.FC<ImageWithOverlayProps> = React.memo(({ image, color, title = "", height = 250 }) => {
  return (
